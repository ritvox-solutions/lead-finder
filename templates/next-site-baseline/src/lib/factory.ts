...
export function sceneFor(category: Category): string {
  switch (category) {
    case "food":
      return "float";
    case "medical":
...
export function taglineFor(category: Category): string {
  switch (category) {
    case "food":
      return "Taste the difference, made fresh for you";
    case "medical":
      return "Caring for your health, close to home";
    case "professional":
      return "Trusted expertise committed to your goals";
    case "retail":
      return "Find what you love, right around the corner";
    case "beauty":
      return "Look good, feel even better";
    case "automotive":
      return "Keep moving, we've got you covered";
    case "home":
      return "Building comfort, one detail at a time";
    case "education":
      return "Learn more, grow further";
    default:
      return "Your neighborhood experts";
  }
}

export function servicesFor(category: Category): string[] {
  switch (category) {
    case "food":
